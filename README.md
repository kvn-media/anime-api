...
```
Now the server is running on http://localhost:3030
...
> This is example project from https://github.com/riimuru/gogoanime.
> In the future i'm gonna try to migrate from node js to golang for smooth and scalable massive access users.